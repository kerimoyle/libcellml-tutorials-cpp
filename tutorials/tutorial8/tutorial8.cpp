...
int main()
{
    ...
    std::string inFileName = "Tutorial8_MembraneModel.cellml";
    ...
    inFileName = "Tutorial7_SodiumChannelModel.cellml";
    inFile.close();
    ...
    inFileName = "Tutorial5_PotassiumChannelModel.cellml";
    inFile.close();
    inFile.open(inFileName);
    std::stringstream().swap(inFileContents);
    inFileContents << inFile.rdbuf();
    ...
    inFileName = "Tutorial8_LeakageCurrentModel.cellml";
    inFile.close();
    inFile.open(inFileName);
    std::stringstream().swap(inFileContents);
    inFileContents << inFile.rdbuf();
